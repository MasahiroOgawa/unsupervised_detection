...
video_basename, _ = os.path.splitext(os.path.basename(video_fname))
...
outimg_dir = img_rootdir + video_basename  # same directory architecture with DAVIS
...
subprocess.call(
    [
        ...
        out_fps,
        "-vf",
        "scale=" + str(out_width) + ":" + str(out_height),
        outimg_dir + "/%05d.jpg",
    ]
)
...
annotimg_dirname = script_dir + "/../download/video/Annotations/480p/" + video_basename
...
relative_img_dir = "/JPEGImages/480p/" + video_basename + "/"
relative_annot_imgname = "/Annotations/480p/" + video_basename + "/00000.png"
...
# debug
print("Video file: ", video_fname)
print("Image directory: ", outimg_dir)
print("Image list file: ", imglist_fname)
for fname in fnames:
    print("  ", fname)
