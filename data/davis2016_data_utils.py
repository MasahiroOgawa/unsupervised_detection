...
class Davis2016Reader(object):
    def __init__(self, root_dir, max_temporal_len=3, min_temporal_len=1, num_threads=6):
        self.root_dir = root_dir
        self.max_temporal_len = max_temporal_len
        self.min_temporal_len = min_temporal_len
        assert (
            min_temporal_len < max_temporal_len
        ), "Temporal lenghts are not consistenst"
    ...
    def image_inputs(
        self, batch_size=32, partition="train", train_crop=1.0, num_threads=6
    ):
