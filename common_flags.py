...
gflags.DEFINE_integer(
    'batch_size', 16, 'Batch size in training and evaluation')
gflags.DEFINE_float("beta1", 0.9, "Momentum term of adam")
gflags.DEFINE_float("flow_normalizer", 80.0,
                    "Scale for regularization of flow")
...
gflags.DEFINE_float("train_crop", 0.9,
                    "minimum random cropping percentage of input images")
...
gflags.DEFINE_integer(
    "iters_gen", 3, "training iteration of generator per step")
...
# Path Parameters
gflags.DEFINE_string('root_dir', "/your/path/to/DAVIS_2016",
                     'Folder containig the evaluation dataset')
gflags.DEFINE_string('train_partition', 'trainval',
                     'Training Partition to be used')
...
gflags.DEFINE_integer("log_level", 0, "0: no log but save the result images, 1: print log, "
                      "2: display image, 3: detailed debug image without stopping, 4: with stop")
