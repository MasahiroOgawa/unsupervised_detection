    ...
    with sv.managed_session() as sess:
        ...
        for step in range(n_steps):
            ...
            if FLAGS.generate_visualization:
                ...
                matlab_out = {}
                for crop in test_crops:
                    matlab_out["img_1_{:03d}".format(int(crop * 100))] = outputs[
                        "img_1s"
                    ][crop]
                    matlab_out["pred_mask_{:03d}".format(int(crop * 100))] = outputs[
                        "pred_masks"
                    ][crop]
                    matlab_out["gt_mask_{:03d}".format(int(crop * 100))] = outputs[
                        "gt_masks"
                    ][crop]
